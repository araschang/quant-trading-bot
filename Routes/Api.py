...
scheduler.add_job(job_bitcoin_signal, 'interval', seconds=7)
scheduler.add_job(job_eth_signal, 'interval', seconds=7)
scheduler.add_job(job_trade, 'interval', seconds=7, next_run_time=datetime.datetime.now() + datetime.timedelta(seconds=1))
scheduler.add_job(check_stoploss_order, 'interval', seconds=7, next_run_time=datetime.datetime.now() + datetime.timedelta(seconds=3))
scheduler.add_job(job_trend_detect, 'interval', seconds=7, next_run_time=datetime.datetime.now() + datetime.timedelta(seconds=5))
scheduler.add_job(job_check_if_no_position_then_cancel_open_order, 'interval', seconds=7, next_run_time=datetime.datetime.now() + datetime.timedelta(seconds=6))
